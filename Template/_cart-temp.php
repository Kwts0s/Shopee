              ...
              <div class="col-sm-8">
                ...
                <div class="qty d-flex pt-2">
                  <div class="d-flex font-rale w-25">
                    <button class="qty-up border bg-light mt-3" data-id="<?=$item['item_id']??'0'; ?>"><i class="fas fa-angle-up"></i></button>
                    <input type="text" data-id="<?=$item['item_id']??'0'; ?>" class="qty_input border px-2 mt-3 w-50 bg-light text-center" disabled value="1" placeholder="1">
                    <button class="qty-down border bg-light mt-3" data-id="<?=$item['item_id']??'0'; ?>"><i class="fas fa-angle-down"></i></button>
                  </div>

                  <form method="post">
                    <input type="hidden" value="<?= $item['item_id'] ?>" name="item_id">
                    <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger px-3 mt-3 border-right">Delete</button>
                  </form>
                  
                  <form method="post">
                    <input type="hidden" value="<?= $item['item_id'] ?>" name="item_id">
                    <button type="submit" name="wishlist-submit" class="btn font-baloo text-danger mt-3">Save for Later</button>
                  </form>
